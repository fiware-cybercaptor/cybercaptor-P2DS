...
public class PrimitivesMessage extends MessageBase implements Serializable {
    ...
    /**
     * contains the data for the operations from
     * MpcShamirSharingProtocolPrimitives
     */
    long[] operationsData = null;

    public PrimitivesMessage() { /* jaxb needs this */
    }
     ...
     */
    public PrimitivesMessage(final String senderID, final int senderIndex) {
        super(senderID, senderIndex);
    }

    /**
     * returns the data for the operations from
     * MpcShamirSharingProtocolPrimitives
     * 
     ...
     */
    public void setOperationsData(final long[] operationsData) {

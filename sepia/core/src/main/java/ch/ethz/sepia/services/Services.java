...
public class Services {
    //private static final XLogger logger = new XLogger(LoggerFactory.getLogger(Services.class);
     ...
     */
    public synchronized static BigInteger[] addVectors(final BigInteger[] inputVector01, final BigInteger[] inputVector02) throws Exception {
     ...
     * @return Sum of each item of the input vectors
     */
    public synchronized static double[] addVectors(final double[] inputVector01, final double[] inputVector02) throws Exception {
        double[] resultVector;
     ...
     * @return Sum of each item of the input vectors
     */
    public synchronized static long[] addVectors(final long[] inputVector01, final long[] inputVector02) throws Exception {
        long[] resultVector;
     ...
     */
    public synchronized static boolean checkFileExists(final String fileName) {
        File myFile;
     ...
     * </ul>
     */
    private static boolean compareFiles(final String[] inputFileList, final String[] outputFileList, final boolean useBigIntegers, final boolean createOutputFile) throws Exception {
     ...
     */
    public synchronized static boolean compareVectors(final BigInteger[] array01, final BigInteger[] array02) throws Exception {
        boolean comparisonSuccessful;
     ...
     * Compares two vectors.
     */
    public synchronized static boolean compareVectors(final double[] array01, final double[] array02) throws Exception {
        boolean comparisonSuccessful;
     ...
     */
    public synchronized static Object deSerialize(final byte[] serializedObject) throws Exception {
        Object object;
     ...
     */
    public static long fastExponentiation(final long term, long exponent) throws Exception {
        long p;
        long q;
        String errorMessage;
     ...
     */
    public synchronized static LineNumberReader initializeLineNumberReader(final File file) throws Exception {
     ...
     */
    public synchronized static LineNumberReader initializeLineNumberReader(final String fileName) throws Exception {
     ...
     */
    public synchronized static Properties loadProperties(final String propertyFileName) throws Exception {
     ...
     */
    protected synchronized static void printItem(final String fileName, final String beginOfLine, final long[] data) throws Exception {
     ...
     */
    public synchronized static void printVector(final String title, final int[] vector, final XLogger logger) {
        String vectorItems;
     ...
     * Print the given array
     */
    public synchronized static void printVector(final String title, final long[] vector, final XLogger logger) {
        StringBuilder line = new StringBuilder();

        logger.info(title);

        if (vector != null) {
            for (final long l : vector) {
     ...
     */
    public synchronized static Vector<String> readFile(final String filePath) throws Exception {
        FileInputStream in;
     ...
     */
    public synchronized static byte[] serialize(final Object object) throws Exception {
     ...
     */
    public synchronized static void writeFile(final byte[] bytes, final String fileName) throws Exception {
        FileOutputStream out;
        PrintStream printOut;
     ...
     * @param fileName The file's name
     */
    public synchronized static void writeFile(final String line, final String fileName) throws Exception {
        String[] lines;
     ...
     * @param fileName The file's name
     */
    public synchronized static void writeFile(final String[] lines, final String fileName) throws Exception {
        FileOutputStream out;
        PrintStream printOut;

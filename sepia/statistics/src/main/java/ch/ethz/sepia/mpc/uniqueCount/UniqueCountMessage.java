...
/**
 * message used to exchange data among (privacy) peers in the uniquecount protocol
 *
 * @author Dilip Many
 *
 */
public class UniqueCountMessage extends MessageBase implements Serializable {
	...
	/**
	 * creates a new uniquecount protocol message with the specified sender id and index
	 *
	 * @param senderID		the senders id
	 * @param senderIndex	the senders index
	 */
	public UniqueCountMessage(String senderID, int senderIndex) {

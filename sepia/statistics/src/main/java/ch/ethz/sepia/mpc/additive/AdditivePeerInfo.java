...
/**
 * stores information about a ADDITIVE (privacy) peer
 * 
 * @author Dilip Many
 *
 */
public class AdditivePeerInfo {
	...
	private boolean isVerificationSuccessful = true;
	
	public boolean isVerificationSuccessful() {
		return isVerificationSuccessful;
	}

	public void setVerificationSuccessful(boolean isVerificationSuccessful) {
		this.isVerificationSuccessful = isVerificationSuccessful;
	}


	/**
	 * Creates a new ADDITIVE info object
	 */
	public AdditivePeerInfo(String ID, int index) {
		this.ID = ID;
		this.index = index;
	}

...
/**
 * stores information about a uniquecount (privacy) peer
 * 
 * @author Dilip Many
 *
 */
public class UniqueCountPeerInfo {
	...
	/**
	 * Creates a new uniquecount info object
	 */
	public UniqueCountPeerInfo(String ID, int index) {
		this.ID = ID;
		this.index = index;
	}

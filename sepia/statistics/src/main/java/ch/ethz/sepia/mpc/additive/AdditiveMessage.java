...
public class AdditiveMessage extends MessageBase implements Serializable {
	...
	/**
	 * creates a new ADDITIVE protocol message with the specified sender id and index
	 *
	 * @param senderID		the senders id
	 * @param senderIndex	the senders index
	 */
	public AdditiveMessage(String senderID, int senderIndex) {
	...
	public String toString() {
	    return "[isGoodBye=" + isGoodbyeMessage()
	            + ";isHello=" + isHelloMessage()
	            + ";isInitialShares=" + isInitialSharesMessage()
	            + ";isFinalResult=" + isFinalResultMessage()
	            + "]";

...
/**
 * Protocol between a privacy peer and a peer for the uniquecount protocol.
 *
 * @author Dilip Many
 *
 */
public class UniqueCountProtocolPrivacyPeerToPeer extends UniqueCountProtocol {
    private static final Logger logger = LogManager.getLogger(UniqueCountProtocolPrivacyPeerToPeer.class);
	 ...
	 * @throws Exception
	 */
	public UniqueCountProtocolPrivacyPeerToPeer(int threadNumber, UniqueCountPrivacyPeer privacyPeer, String inputPeerId, int inputPeerIndex, Stopper stopper)  {
	...
	/**
	 * Run the MPC uniquecount computation protocol for the peer.
	 */
	public void run() {
	...
	protected void sendFinalResult() throws PrivacyViolationException {
		// create message
		messageToSend = new UniqueCountMessage(myPeerID, myPeerIndex);
